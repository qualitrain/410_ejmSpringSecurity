...
@EnableJpaRepositories(
		basePackages = "mx.com.qtx.ejmSpSec.seguridad.persistencia",
...
public class ConfigRepositoriosJpaSeguridad {
	...
	private static final String[] PACK_SCAN_ENT_JPA= {"mx.com.qtx.ejmSpSec.seguridad.entidades"};
	
	@Qualifier("bdSegPersonalizada")
	@Autowired
